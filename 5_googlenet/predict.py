...
def main():
    ...
    json_path = '/home/xiongkouqin/projects/image_classify/5_googlenet/class_indices.json'
    ...
    net_path = '/home/xiongkouqin/projects/image_classify/5_googlenet/googlenet.pth'
    assert os.path.exists(net_path), f'net path {net_path} does not exist!'
    net.load_state_dict(torch.load(net_path), strict=False) # 因为辅助分类器在这里不需要
