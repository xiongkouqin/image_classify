...
def main():
    ...
    project_root = '/home/xiongkouqin/projects/image_classify/6_resnet'
    ...
    print(net)
    fc_in_featurs = net.fc.in_features
    net.fc = nn.Linear(fc_in_featurs, 5)
    ...
    num_epochs = 2
    save_path = os.path.join(project_root, 'resnet34.pth')
    best_acc = 0.0
